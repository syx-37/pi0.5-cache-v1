...
from transformers.utils import LossKwargs, ModelOutput, auto_docstring, can_return_tuple, is_torchdynamo_compiling, logging
from transformers.models.auto import AutoModel
# Configuration class is upstream — we don't patch the config, only the modeling.
